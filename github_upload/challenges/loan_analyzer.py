...
print ("the average loan amount is:", loan_average)
print()
print("----")
print()
...
if fair_value >= loan_price:
    ...
    print("The loan is too expensive, don't buy")
...
def calculate_present_value(future_value, remaining_months, annual_discount):
